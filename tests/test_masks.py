...
@pytest.mark.parametrize("input_card, expected_output", [("7000792289606361", "7000 79** **** 6361")])
def test_mask_card_number(input_card, expected_output):
    assert mask_card_number(input_card) == expected_output


@pytest.mark.parametrize("input_number, expected", [("73654108430135874305", "**4305")])
