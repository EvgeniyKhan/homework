...
@pytest.mark.parametrize("input_state, expected_out", [
    ('EXECUTED', [
...
def test_filter_by_state(sample_data_state, input_state, expected_out):
    result = filter_by_state(sample_data_state, input_state)
